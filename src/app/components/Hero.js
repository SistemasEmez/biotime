...
export default function Hero({ type }) {
  ...
  const [punchs, setPunchs] = useState(null);
  ...
  return (
    <>
      <div className="overflow-hidden bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-8">
            {/* Hero Title Section */}
            <div className="text-center relative z-10">
              <p className="text-xs font-semibold text-blue-600 dark:text-blue-400 tracking-wide uppercase mb-3 inline-flex items-center">
                <span className="mr-2">
                  <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                  </svg>
                </span>
                La solución para reportes de entradas y salidas de personal.
              </p>
              <h1 className="text-3xl text-slate-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight dark:text-slate-100">
                Optimiza tus tiempos con{" "}
                <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">reportes de fácil acceso</span>
              </h1>
              
              <div className="mt-5 max-w-2xl mx-auto">
                <p className="text-slate-600 dark:text-slate-300 text-lg">
                  Obtén informes detallados en segundos para mejorar la productividad de tu equipo.
                </p>
              </div>
            </div>

            {/* Images and Stats Section */}
            <div className="sm:flex sm:justify-center sm:items-center text-center sm:text-left bg-white/40 dark:bg-slate-800/40 backdrop-blur-sm rounded-xl p-4 border border-slate-200 dark:border-slate-700">
              <div className="flex-shrink-0 pb-5 sm:flex sm:pb-0 sm:pr-5">
                <div className="flex justify-center -space-x-3">
                  ...
                  <span className="inline-flex items-center justify-center h-8 w-8 rounded-full ring-2 ring-white bg-gradient-to-br from-blue-600 to-cyan-600 dark:ring-slate-700">
              ...
              <div className="border-t sm:border-t-0 sm:border-l border-slate-200 dark:border-slate-700 w-32 h-px sm:w-auto sm:h-full mx-auto sm:mx-0"></div>
            ...
            {/* Date Selector Box */}
            <div className="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border border-slate-200 rounded-xl shadow-lg shadow-slate-200/50 dark:bg-slate-800 dark:border-slate-700 dark:shadow-slate-900/30">
              <div className="pb-2 sm:pb-0 sm:flex-[1_0_0%]">
                ...
                <input
                  type="date"
                  id="date-one"
                  className="py-3 px-4 block w-full border-slate-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 sm:p-4 dark:bg-slate-900 dark:border-slate-700 dark:text-slate-300"
                  onChange={handleStartDateChange}
                />
              </div>
              <div className="pt-2 sm:pt-0 sm:pl-3 border-t border-slate-200 sm:border-t-0 sm:border-l sm:flex-[1_0_0%] dark:border-slate-700">
                <label
                  htmlFor="date-two"
                  className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1"
                >
              ...
              <div className="pt-2 sm:pt-0 grid sm:block sm:flex-[0_0_auto] self-end">
                <button
                  onClick={handleSearch}
                  disabled={isLoading}
                  className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-lg border border-transparent font-semibold bg-gradient-to-r from-blue-600 to-cyan-600 text-white hover:from-blue-700 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm sm:p-4 dark:focus:ring-offset-slate-800 disabled:opacity-70"
                >
                  {isLoading ? (
                    <>
            ...
            {/* Decorative elements - more subtle for better focus on content */}
            <div
              className="hidden absolute top-2/4 left-0 transform -translate-y-2/4 -translate-x-40 md:block lg:-translate-x-80 opacity-70 dark:opacity-30"
              aria-hidden="true"
            >
              <svg
            ...
            <div
              className="hidden absolute top-2/4 right-0 transform -translate-y-2/4 translate-x-40 md:block lg:translate-x-80 opacity-70 dark:opacity-30"
              aria-hidden="true"
            >
              <svg
      ...
      {isLoading ? (
        ...
        showPunchTable && punchs && (
          <div className="bg-slate-50 dark:bg-slate-900 py-6">
            <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-200">Resultados de la búsqueda</h2>
                <p className="text-slate-600 dark:text-slate-400 mt-2">
                  Mostrando datos desde {startDate} hasta {endDate}
                </p>
              </div>
